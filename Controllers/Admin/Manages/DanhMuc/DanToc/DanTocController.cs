...
namespace QLViecLam.Controllers.Admin.Manages.DanhMuc.DanToc
{
    public class DanTocController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            return View("Views/Admin/Manages/Danhmuc/DanToc/Index.cshtml", model);
        }
        [Route("DanToc/Store")]
        [HttpPost]
        public IActionResult Store(string TenDanToc_create, int MaDanToc_create, string TrangThai_create)
        {
            var model = new Models.Admin.Manages.DanhMuc.DanToc
            {
