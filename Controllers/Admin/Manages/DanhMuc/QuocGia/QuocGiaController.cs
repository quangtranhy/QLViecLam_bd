...
namespace QLViecLam.Controllers.Admin.Manages.DanhMuc.QuocGia
{
    public class QuocGiaController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewData["MenuLv2"] = "menu_quanlydanhmuc_quocgia";
            return View("Views/Admin/Manages/Danhmuc/QuocGia/Index.cshtml", model);
        }
        [Route("QuocGia/Store")]
        [HttpPost]
        public IActionResult Store(string TenQuocGia_create, string MaQuocGia_create, string TrangThai_create)
        {
            var model = new Models.Admin.Manages.DanhMuc.QuocGia
            {
