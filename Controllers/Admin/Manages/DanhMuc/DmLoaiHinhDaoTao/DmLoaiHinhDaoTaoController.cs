...
namespace QLViecLam.Controllers.Admin.Danhmuc.Danhmuc.DmLoaiHinhDaoTao
{
    public class DmLoaiHinhDaoTaoController : Controller
    {
        ...
        public IActionResult Index()
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                ...
                if (check_per)
                {
                    ...
                    return View("Views/Admin/Manages/Danhmuc/DmLoaiHinhDaoTao/Index.cshtml", model);
                }
                else
                {
        ...
        [HttpPost]
        public IActionResult Store(Models.Admin.Manages.DanhMuc.DmLoaiHinhDaoTao request)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                bool check_per = true;
                if (check_per)
                {
                    var model = new Models.Admin.Manages.DanhMuc.DmLoaiHinhDaoTao
                    {
        ...
        [HttpPost]
        public IActionResult Update(Models.Admin.Manages.DanhMuc.DmLoaiHinhDaoTao request)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                bool check_per = true;
