...
namespace QLViecLam.Controllers.Admin.Manages.DanhMuc.NganhHoc
{
    public class NganhHocController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            return View("Views/Admin/Manages/Danhmuc/NganhHoc/Index.cshtml", model);
        }
        ...
        {
            var model = new Models.Admin.Manages.DanhMuc.NganhHoc
            {
