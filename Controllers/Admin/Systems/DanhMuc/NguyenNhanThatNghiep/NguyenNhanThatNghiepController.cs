...
namespace QLViecLam.Controllers.Admin.Systems.DanhMuc.NguyenNhanThatNghiep
{
    public class NguyenNhanThatNghiepController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            return View("Views/Admin/Systems/Danhmuc/DmNguyenNhanThatNghiep/Index.cshtml", model);
        }
