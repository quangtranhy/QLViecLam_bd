...
namespace QLViecLam.Controllers.Admin.Systems.DanhMuc.DmXuatKhauLaoDong
{
    public class DmXuatKhauLaoDongController : Controller
    {
        ...
        public IActionResult Index()
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                ...
                if (check_per)
                {
                    ...
                    return View("Views/Admin/Systems/Danhmuc/DmXuatKhauLaoDong/Index.cshtml", model);
                }
                else
                {
        ...
        [HttpPost]
        public IActionResult Store(Models.Admin.Systems.DanhMuc.DmXuatKhauLaoDong request)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                bool check_per = true;
                if (check_per)
                {
                    var model = new Models.Admin.Systems.DanhMuc.DmXuatKhauLaoDong
                    {
        ...
        [HttpPost]
        public IActionResult Update(Models.Admin.Systems.DanhMuc.DmXuatKhauLaoDong request)
        {
