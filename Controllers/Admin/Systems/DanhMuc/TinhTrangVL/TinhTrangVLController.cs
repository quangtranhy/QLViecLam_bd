...
namespace QLViecLam.Controllers.Admin.Systems.DanhMuc.TinhTrangVL
{
    public class TinhTrangVLController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewData["MenuLv2"] = "danhmuc_tinhtrangvl";
        ...
        {
            var model = new Models.Admin.Systems.DanhMuc.TinhTrangVL
            {
