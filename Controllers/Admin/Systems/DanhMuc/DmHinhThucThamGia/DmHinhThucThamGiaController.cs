...
namespace QLViecLam.Controllers.Admin.Systems.DanhMuc.DmHinhThucThamGia
{
    public class DmHinhThucThamGiaController : Controller
    {
        ...
        public IActionResult Index()
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                ...
                if (check_per)
                {
                    ...
                    return View("Views/Admin/Systems/Danhmuc/DmHinhThucThamGia/Index.cshtml", model);
                }
                else
                {
        ...
        [HttpPost]
        public IActionResult Store(Models.Admin.Systems.DanhMuc.DmHinhThucThamGia request)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                bool check_per = true;
                if (check_per)
                {
                    var model = new Models.Admin.Systems.DanhMuc.DmHinhThucThamGia
                    {
        ...
        [HttpPost]
        public IActionResult Update(Models.Admin.Systems.DanhMuc.DmHinhThucThamGia request)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                bool check_per = true;
