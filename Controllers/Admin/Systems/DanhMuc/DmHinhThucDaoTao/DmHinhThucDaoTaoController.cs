...
namespace QLViecLam.Controllers.Admin.Systems.DanhMuc.DmHinhThucDaoTao
{
    public class DmHinhThucDaoTaoController : Controller
    {
        ...
        public IActionResult Index()
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                ...
                if (check_per)
                {
                    ...
                    return View("Views/Admin/Systems/Danhmuc/DmHinhThucDaoTao/Index.cshtml", model);
        ...
        [HttpPost]
        public IActionResult Store(Models.Admin.Systems.DanhMuc.DmHinhThucDaoTao request)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                bool check_per = true;
                if (check_per)
                {
                    var model = new Models.Admin.Systems.DanhMuc.DmHinhThucDaoTao
                    {
        ...
        [HttpPost]
        public IActionResult Update(Models.Admin.Systems.DanhMuc.DmHinhThucDaoTao request)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                bool check_per = true;
