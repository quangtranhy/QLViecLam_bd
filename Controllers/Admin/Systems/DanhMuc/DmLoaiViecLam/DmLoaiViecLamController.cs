...
namespace QLViecLam.Controllers.Admin.Systems.DanhMuc.DmLoaiViecLam
{
    public class DmLoaiViecLamController : Controller
    {
        ...
        public IActionResult Index()
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                ...
                if (check_per)
                {
                    ...
                    return View("Views/Admin/Systems/Danhmuc/DmLoaiViecLam/Index.cshtml", model);
                }
                else
                {
        ...
        [HttpPost]
        public IActionResult Store(Models.Admin.Systems.DanhMuc.DmLoaiViecLam request)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                bool check_per = true;
                if (check_per)
                {
                    var model = new Models.Admin.Systems.DanhMuc.DmLoaiViecLam
                    {
        ...
        [HttpPost]
        public IActionResult Update(Models.Admin.Systems.DanhMuc.DmLoaiViecLam request)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                bool check_per = true;
