...
namespace QLViecLam.Controllers.Admin.Systems.DanhMuc.DmDoiTuongChinhSach
{
    public class DmDoiTuongChinhSachController : Controller
    {
        ...
        public IActionResult Index()
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                ...
                if (check_per)
                {
                    ...
                    return View("Views/Admin/Systems/Danhmuc/DmDoiTuongChinhSach/Index.cshtml", model);
                }
                else
                {
        ...
        [HttpPost]
        public IActionResult Store(Models.Admin.Systems.DanhMuc.DmDoiTuongChinhSach request)
        {
            var model = new Models.Admin.Systems.DanhMuc.DmDoiTuongChinhSach
            {
        ...
        [HttpPost]
        public IActionResult Update(Models.Admin.Systems.DanhMuc.DmDoiTuongChinhSach request)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                bool check_per = true;
